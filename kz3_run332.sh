#!/bin/bash
# K-Z3 10:00 hour n-add: run332A-C (n=20 each) + landing control
URL_S="https://search.kotobase.net/search?q=test"
URL_L="https://kotobase.net/signup"
OUT="/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/kz3_run332_out.txt"
: > "$OUT"
for rid in 332A 332B 332C; do
