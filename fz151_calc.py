...
runs = parse("/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/kz3_run151_out.txt")
lines = []
...
with open("/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/fz151_calc.txt", "w") as f:
    f.write("\n".join(lines) + "\n")
print("\n".join(lines))
