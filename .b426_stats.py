...
files = [".b426_run426_A.txt", ".b426_run426_B.txt", ".b426_run426_C.txt", ".b426_run426_land.txt"]
names = ["run426A", "run426B", "run426C", "landing"]
...
with open(".b426_stats_out.txt","w") as f:
    f.write("\n".join(lines))
    f.write("\n")
