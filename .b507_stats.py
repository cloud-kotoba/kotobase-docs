#!/usr/bin/env python3
# K-Z3 stats for run507 (nearest-rank p50, cold>=0.5s), ASCII-safe output
import os

BASE = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.run507_raw"
COLD = 0.5
...
res = []
res.append(stats(os.path.join(BASE, "runA", "resp.txt"), "run507A"))
res.append(stats(os.path.join(BASE, "runB", "resp.txt"), "run507B"))
res.append(stats(os.path.join(BASE, "runC", "resp.txt"), "run507C"))
