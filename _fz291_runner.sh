#!/bin/bash
# falsify: K-Z3 3時台(深夜帯) n 積み増し run291A-C (n=20 x3) + landing control
URL_S="https://search.kotobase.net/search?q=test"
URL_L="https://kotobase.net/signup"
OUT="/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/_fz291_out.txt"
: > "$OUT"
for rid in 291A 291B 291C; do
