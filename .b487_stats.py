# bench 212 K-Z3 run487 stats: nearest-rank p50, cold>=0.5s, http200
import os
B = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b487"
OUTF = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b487_stats_out.txt"
THRESH = 0.5
...
out.append(sumline); print(sumline)
land = [o for o in out if o.startswith("RUNlanding")][0]
out.append(land); print(land)
