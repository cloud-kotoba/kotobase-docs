...
files = [".b427_run427_A.txt", ".b427_run427_B.txt", ".b427_run427_C.txt", ".b427_run427_land.txt"]
names = ["run427A", "run427B", "run427C", "landing"]
...
with open(".b427_stats_out.txt","w") as f:
    f.write("\n".join(lines))
    f.write("\n")
