#!/usr/bin/env python3
# parse .b479_{A,B,C,landing}.raw (each line "code ttfb") into separate .code and .ttfb
base = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b479"
