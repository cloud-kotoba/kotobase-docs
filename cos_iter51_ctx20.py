...
s = r.stdout
print("len", len(s))
print("kv-stats in built artifact:", s.count("x-kotobase-kv-stats"))
print("block-fetch-stats-summary in built artifact:", s.count("block-fetch-stats-summary"))
print("kv= in built artifact:", s.count("kv="))
