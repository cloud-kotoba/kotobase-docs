// bench66 — K-Z3 4時台 2 セット目 (run183A-C)
...
const SEARCH = "https://search.kotobase.net/search?q=bench66kz3";
...
const result = { purpose: "bench66 K-Z3 4時台 2 セット目 (run183A-C)", observedAt: new Date().toISOString(), runs: [] };
for (let r = 0; r < 3; r += 1) {
  const runs = [];
