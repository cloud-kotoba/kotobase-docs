...
with open('/tmp/b455_out.txt', 'w') as fo:
    for label, path in [('run455A', '.b455_run455A_raw.ttfb'),
                        ('run455B', '.b455_run455B_raw.ttfb'),
                        ('run455C', '.b455_run455C_raw.ttfb'),
                        ('landing', '.b455_landing_raw.ttfb')]:
