...
def parse_raw(path):
    """Return (codes_list, times_list, cold_positions) from lines 'http_code time'."""
    codes = []
    times = []
    coldpos = []
    i = 0
...
with open('/tmp/b454_out.txt', 'w') as fo:
    for label, path in [('run454A', '.b454_run454A_raw.ttfb'),
                        ('run454B', '.b454_run454B_raw.ttfb'),
                        ('run454C', '.b454_run454C_raw.ttfb'),
                        ('landing', '.b454_landing_raw.ttfb')]:
