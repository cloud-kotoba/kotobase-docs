#!/bin/sh
# K-Z3 search cold-band n-add run423 (5時台帯 2セット目, 2026-09-08)
...
run_one ".b423_run423_A.txt" "$Q"
run_one ".b423_run423_B.txt" "$Q"
run_one ".b423_run423_C.txt" "$Q"
run_one ".b423_run423_land.txt" "$CTRL"
echo "run423-DONE" > .b423_done.txt