#!/bin/sh
# K-Z3 search cold-band n-add run438 (8時台帯 n 積み増し, 2026-09-08 falsify)
...
run_one ".b438_run438_A.txt" "$Q"
run_one ".b438_run438_B.txt" "$Q"
run_one ".b438_run438_C.txt" "$Q"
run_one ".b438_run438_land.txt" "$CTRL"
echo "run438-DONE" > .b438_done.txt