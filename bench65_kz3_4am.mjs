// bench65 — K-Z3 4時台帯初計測 (rank 第64回 fallback, 本 tick 独自分)
...
const SEARCH = "https://search.kotobase.net/search?q=bench65kz3";
...
const result = { purpose: "bench65 K-Z3 4時台帯初計測 (run182A-C)", observedAt: new Date().toISOString(), runs: [] };
for (let r = 0; r < 3; r += 1) {
  const runs = [];
