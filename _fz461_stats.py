...
runs = {'A': 'run461A', 'B': 'run461B', 'C': 'run461C'}
total_cold = 0
total_n = 0
for rk, rn in sorted(runs.items()):
    vals = load(f'.fz461_run461_{rk}.ttfb')
...
lv = load('.fz461_run461_landing.ttfb')
...
print(f'TOTAL_SEARCH_COLD={total_cold}/{total_n}')
print(f'ROW459_COLD_STR={total_cold}/{total_n}')