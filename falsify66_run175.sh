#!/bin/bash
# K-Z3 falsify run175A-C (search) + landing control, same method as prior runs.
OUT=/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/falsify66_run175_out.txt
: > "$OUT"
date >> "$OUT"
uptime >> "$OUT"
for run in A B C; do
