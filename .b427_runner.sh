#!/bin/sh
# K-Z3 search cold-band n-add run427 (6時台帯 n 積み増し, 2026-09-08 falsify 第188回)
...
run_one ".b427_run427_A.txt" "$Q"
run_one ".b427_run427_B.txt" "$Q"
run_one ".b427_run427_C.txt" "$Q"
run_one ".b427_run427_land.txt" "$CTRL"
echo "run427-DONE" > .b427_done.txt