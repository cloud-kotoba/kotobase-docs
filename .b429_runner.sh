#!/bin/sh
# K-Z3 search cold-band n-add run429 (6時台帯 n 積み増し, 2026-09-08 falsify 第188回)
...
run_one ".b429_run429_A.txt" "$Q"
run_one ".b429_run429_B.txt" "$Q"
run_one ".b429_run429_C.txt" "$Q"
run_one ".b429_run429_land.txt" "$CTRL"
echo "run429-DONE" > .b429_done.txt