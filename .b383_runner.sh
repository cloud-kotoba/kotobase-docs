...
date '+start %Y-%m-%dT%H:%M:%S%z' > .b383_time.txt
uptime >> .b383_time.txt
run_url "$SEARCH" .b383_383A.txt
run_url "$SEARCH" .b383_383B.txt
run_url "$SEARCH" .b383_383C.txt
run_url "$LAND" .b383_land.txt
date '+end %Y-%m-%dT%H:%M:%S%z' >> .b383_time.txt
uptime >> .b383_time.txt
echo "done rc=$?"