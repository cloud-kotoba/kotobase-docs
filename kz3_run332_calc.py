...
txt = open("/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/kz3_run332_out.txt").read().splitlines()
blocks = {}
cur = None
for line in txt:
...
print("\n".join(res))
# per-index dump for cold positions
print("--- cold detail ---")
cur=None
for line in txt:
    if line.startswith("=== run"):
