// falsify 第71回 — K-Z3 6時台 n 積み増し (run190A–C)
...
const SEARCH = "https://search.kotobase.net/search?q=f71kz3";
...
const result = { purpose: "falsify71 K-Z3 6時台 n 積み増し (run190A-C)", observedAt: new Date().toISOString(), runs: [] };
for (let r = 0; r < 3; r += 1) {
  const runs = [];
