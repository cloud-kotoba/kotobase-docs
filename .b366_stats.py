...
def stats(fn):
    ...
    # nearest-rank p50: sort asc, idx = ceil(0.50*n)
    s=sorted(tts)
    import math
...
out=[]
for fn in ["b366_366A.txt","b366_366B.txt","b366_366C.txt","b366_land.txt"]:
    # prefix . in filename
    out.append(stats("."+fn))
import json
with open(os.path.join(base,".b366_stats_out.txt"),"w") as f:
