#!/usr/bin/env python3
# parse .b472_out.txt into per-run .ttfb/.code files (one value per line)
OUT = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b472_out.txt"
base = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b472"
cur = None
buckets = {}
...
with open("/tmp/b472_buckets.txt", "w", encoding="utf-8") as dbg:
