...
for k, v in d.items():
    ...
    print(f"{k}: n={n} non200={codes.count(0)+sum(1 for c in codes if c!=200)} cold(>=0.5s)={cold} p50={p50*1000:.0f}ms p95={p95*1000:.0f}ms max={max(times)*1000:.0f}ms")
