// bench69 — K-Z3 6時台 n 積み増し (rank 第67回 fallback, 本 tick 独自分)
...
const SEARCH = "https://search.kotobase.net/search?q=bench69kz3";
...
const result = { purpose: "bench69 K-Z3 6時台 n 積み増し (run186A-C)", observedAt: new Date().toISOString(), runs: [] };
for (let r = 0; r < 3; r += 1) {
  const runs = [];
