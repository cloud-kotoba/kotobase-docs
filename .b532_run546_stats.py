...
labels=[("A",".b532_run546A.ttfb"),("B",".b532_run546B.ttfb"),("C",".b532_run546C.ttfb"),("land",".b532_run546land.ttfb")]
...
for lbl,fn in labels:
    ...
    if lbl!="land":
        ...
        print(f"land: n={n} 200={ok} cold>=0.5s={len(cold)} p50={p50:.4f} max={mx:.4f}")
allt.sort()
print(f"TOTAL search: n={tot_n} 200={tot_200} cold={tot_cold} ({100.0*tot_cold/max(tot_n,1):.1f}%) p50={allt[len(allt)//2]:.4f} max={allt[-1]:.4f}")
