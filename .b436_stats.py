...
files = [".b436_run436_A.txt", ".b436_run436_B.txt", ".b436_run436_C.txt", ".b436_run436_land.txt"]
names = ["run436A", "run436B", "run436C", "landing"]
...
with open(".b436_stats_out.txt","w") as f:
    f.write("\n".join(lines))
    f.write("\n")
