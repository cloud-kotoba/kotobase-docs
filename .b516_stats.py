#!/usr/bin/env python3
# b516 stats: nearest-rank p50, cold count (ttfb>=0.5), non-200, max
import io, math, os
base = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs"
names = ["run516A", "run516B", "run516C", "landing"]
...
out="\n".join(res)
w=io.open("/tmp/b516_stats_out.txt","w",encoding="utf-8")
w.write(out+"\n"); w.close()
print(out)