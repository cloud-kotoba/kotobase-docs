# bench 211 K-Z3 run486 stats: nearest-rank p50, cold>=0.5s, http200
import os
B = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b486"
THRESH = 0.5
...
for k in ["A","B","C","landing"]:
    ttfb = nrank_ttfb = load_ttfb(B + "_" + k + ".ttfb")
...
with open("/tmp/b486_stats.txt","w",encoding="utf-8") as f:
    f.write("\n".join(out)+"\n")