...
files = [".b429_run429_A.txt", ".b429_run429_B.txt", ".b429_run429_C.txt", ".b429_run429_land.txt"]
names = ["run429A", "run429B", "run429C", "landing"]
...
with open(".b429_stats_out.txt","w") as f:
    f.write("\n".join(lines))
    f.write("\n")
