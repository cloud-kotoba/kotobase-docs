...
runs = {'A': 'run533A', 'B': 'run533B', 'C': 'run533C'}
total_cold = 0
total_n = 0
for rk, rn in sorted(runs.items()):
    vals = load('.b533_run533_%s.ttfb' % rk)
...
lv = load('.b533_run533_landing.ttfb')
...
la = load('.b533_run533_A.ttfb'); lb = load('.b533_run533_B.ttfb'); lc = load('.b533_run533_C.ttfb')
