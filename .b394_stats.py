...
result = {}
for label in ["394A", "394B", "394C", "land"]:
    fn = f"/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b394_394{label}.txt"
    if label == "land":
        fn = "/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b394_394land.txt"
    result[label] = stats(load(fn))

with open("/Users/junkawasaki/github/com-junkawasaki/orgs/net-kotobase/docs/.b394_stats_out.txt", "w") as f:
