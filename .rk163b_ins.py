#!/usr/bin/env python3
# rank tick prepend - clean version
import io
...
# locate the insertion point: right after the Iteration-log header, before the current first entry (bench 169)
needle = "## Iteration log\n-  2026-09-07: bench  第169回"
idx = t.find(needle)
if idx < 0:
...
t2 = t[:idx] + replacement + t[idx+len(needle):]
...
with io.open(P, "w", encoding="utf-8") as f:
    f.write(t2)
print("OK inserted rank163; lines",t2.count("\n")+1)