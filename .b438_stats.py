...
files = [".b438_run438_A.txt", ".b438_run438_B.txt", ".b438_run438_C.txt", ".b438_run438_land.txt"]
names = ["run438A", "run438B", "run438C", "landing"]
...
with open(".b438_stats_out.txt","w") as f:
    f.write("\n".join(lines))
    f.write("\n")
